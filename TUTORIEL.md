...
crée des sous dossiers , permettre de ne pas remplacer un dossier deja
existant
...
script = que des liens de codes et commentaire notebook= zone reserver
au code , affiche les résultats commentaires rearkdom= intermpreter par
gitmb
...
Fnfs= definir une variable , on mets la liste de fichier, pointe vers
une la liste des données, ya les chercher et et recuperer tous les
fichiers contenant
...
![](TUTORIEL_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
